...
using GoWithFlow.API.BackgroundServices;
...
builder.Services.AddScoped<IAudioArchiveRepository, AudioArchiveRepository>();
builder.Services.AddScoped<IAudioArchiveService, AudioArchiveService>();
...
builder.Services.AddSingleton<ISessionRecordingMergeQueue, SessionRecordingMergeQueue>();
builder.Services.AddHostedService<SessionRecordingMergeWorker>();
builder.Services.AddHostedService<SessionRecordingRetentionWorker>();
