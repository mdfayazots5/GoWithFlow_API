...
namespace GoWithFlow.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260516145818_AddMistakeModule_Phase6")]
    partial class AddMistakeModule_Phase6
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoWithFlow.Domain.Entities.Mistake", b =>
                {
                    b.Property<long>("MistakeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("MistakeId"));
                    ...
                    b.ToTable("tblMistake", (string)null);
                });
            ...
            modelBuilder.Entity("GoWithFlow.Domain.Entities.RepracticeSession", b =>
                {
                    b.Property<long>("RepracticeSessionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("RepracticeSessionId"));
                    ...
                    b.Property<decimal>("ImprovementPercent")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("tblRepracticeSession", (string)null);
                });

            modelBuilder.Entity("GoWithFlow.Domain.Entities.RepracticeUtterance", b =>
                {
                    b.Property<long>("RepracticeUtteranceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("RepracticeUtteranceId"));
                    ...
                    b.Property<long>("OriginalUtteranceId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("GoWithFlow.Domain.Entities.UserBadge", b =>
                {
                    b.Property<long>("UserBadgeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("UserBadgeId"));
                    ...
                    b.ToTable("tblUserBadge", (string)null);
                });

            modelBuilder.Entity("GoWithFlow.Domain.Entities.UserStreak", b =>
                {
                    b.Property<long>("UserStreakId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("UserStreakId"));
                    ...
                    b.ToTable("tblUserStreak", (string)null);
                });
            ...
            modelBuilder.Entity("GoWithFlow.Domain.Entities.RepracticeSession", b =>
                {
                    b.HasOne("GoWithFlow.Domain.Entities.Session", "SourceSession")
                        .WithMany()
            ...
            modelBuilder.Entity("GoWithFlow.Domain.Entities.RepracticeUtterance", b =>
                {
                    b.HasOne("GoWithFlow.Domain.Entities.Mistake", "Mistake")
                        .WithMany("RepracticeUtterances")
                        .HasForeignKey("MistakeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_tblRepracticeUtterance_MistakeId_tblMistake_MistakeId");

                    b.HasOne("GoWithFlow.Domain.Entities.Utterance", "OriginalUtterance")
                        .WithMany()
                        .HasForeignKey("OriginalUtteranceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_tblRepracticeUtterance_OriginalUtteranceId_tblUtterance_UtteranceId");

                    b.HasOne("GoWithFlow.Domain.Entities.RepracticeSession", "RepracticeSession")
                        .WithMany("Utterances")
                        .HasForeignKey("RepracticeSessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                    ...
                    b.Navigation("OriginalUtterance");

                    b.Navigation("RepracticeSession");
                });
            ...
            modelBuilder.Entity("GoWithFlow.Domain.Entities.Mistake", b =>
                {
                    b.Navigation("RepracticeUtterances");
                });
